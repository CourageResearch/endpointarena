...
export default function Markets3Page() {
  return (
    <PageFrame>
      ...
      <main className="max-w-5xl mx-auto px-4 sm:px-6 py-8 sm:py-16">
        <div className="mb-8 sm:mb-12">
          <div className="flex items-center gap-3">
            <h1 className="text-xs font-medium text-[#b5aa9e] uppercase tracking-[0.2em]">Prediction Markets: Stacked Layout</h1>
            <HeaderDots />
          </div>
          <p className="mt-3 text-sm text-[#8a8075] sm:text-base">
            Detail pages stack content in this order: market chart, activity feed, details, then model positions.
          </p>
        </div>

        <SquareDivider className="mb-8" />

        <MarketBrowseHomepage detailBasePath="/markets3" />
