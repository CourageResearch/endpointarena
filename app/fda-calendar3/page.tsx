      ...
      <main className="max-w-5xl mx-auto px-4 sm:px-6 py-8 sm:py-16">
        ...
        <div className="mb-8 sm:mb-12">
          <div className="flex items-center gap-3 mb-4">
            <h1 className="text-xs font-medium text-[#b5aa9e] uppercase tracking-[0.2em]">FDA Calendar Cards</h1>
            <HeaderDots />
          </div>
          <p className="text-[#8a8075] text-sm sm:text-base max-w-lg">
            Card-based FDA calendar with per-model prediction drill-down.
          </p>
        </div>

        <FDACalendarCardsWithPredictions events={eventsForClient} filterOptions={filterOptions} />
