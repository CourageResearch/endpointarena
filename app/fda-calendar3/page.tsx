...
import { FDACalendarCardsWithPredictions } from './FDACalendarCardsWithPredictions'
...
export default async function FDACalendar3Page() {
      ...
      <main className="max-w-5xl mx-auto px-4 py-8 sm:px-6 sm:py-16">
        <div className="mb-8 sm:mb-12">
          <div className="mb-4 flex items-center gap-3">
            <h1 className="text-xs font-medium uppercase tracking-[0.2em] text-[#b5aa9e]">FDA Calendar Cards</h1>
            <HeaderDots />
          </div>
          <p className="max-w-lg text-sm text-[#8a8075] sm:text-base">
            Card-based FDA calendar with latest decision snapshots and per-model history.
          </p>
        </div>

        <FDACalendarCardsWithPredictions events={eventsForClient as any} filterOptions={filterOptions} />
