...
async function reportCrash(error: ErrorWithDigest) {
  try {
    ...
    // Ignore logging failures in global error boundary.
  }
}
...
export default function GlobalError({
  ...
  return (
    <html>
      <body className="min-h-screen bg-[#F5F2ED] px-4 py-12 text-[#1a1a1a]">
        <div className="mx-auto max-w-xl rounded-sm border border-[#e8ddd0] bg-white/90 p-6">
          <p className="text-xs font-medium uppercase tracking-[0.18em] text-[#b5aa9e]">System Error</p>
          <h1 className="mt-2 text-xl font-semibold">A critical error occurred.</h1>
