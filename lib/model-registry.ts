...
export const MODEL_REGISTRY = {
  'claude-opus': {
    ...
    runtime: {
      ...
      method: {
        ...
        reasoningDetail: 'No explicit Anthropic thinking parameter configured',
        maxTokens: '6,000 output',
      },
    },
    verifier: {
      provider: 'anthropic',
  ...
  'deepseek-v3.2': {
    ...
    runtime: {
      ...
      method: {
        ...
        reasoningDetail: 'reasoning_effort = none',
  ...
  'glm-5': {
    ...
    color: '#0B9E6F',
    provider: 'Fireworks',
    features: ['Structured Output', 'Long Context'],
    runtime: {
  ...
  'kimi-k2.5': {
    ...
    runtime: {
      ...
      method: {
        ...
        internetDetail: 'No web-search tool configured in the combined decision generator',
        reasoning: 'Provider default',
        reasoningDetail: 'No explicit thinking flag configured',
        maxTokens: '4,096 output',
      },
    },
    costing: {
  ...
  'minimax-m2.5': {
    ...
    runtime: {
      ...
      method: {
        ...
        reasoningDetail: 'reasoning_effort = low',
        maxTokens: '4,096 output',
      },
    },
    costing: {
