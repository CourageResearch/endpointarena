    ...
    <div className="min-h-screen bg-white text-neutral-900">
      ...
      <main className="max-w-6xl mx-auto px-4 sm:px-6 py-8 sm:py-16">
        ...
        <section className="text-center mb-0">
          <h1 className="font-serif text-4xl md:text-5xl lg:text-6xl font-light tracking-tight leading-[1.08] mb-4">
            The FDA <em className="italic">Prediction</em> Challenge
          </h1>
        ...
        {/* Divider: Hero → Leaderboard */}
        <div className="flex justify-center my-8 sm:my-12">
          <div className="w-px h-12 sm:h-16 bg-neutral-200" />
        </div>

        {/* Leaderboard */}
        <section className="mb-0">
          <h2 className="text-xs font-medium text-neutral-400 uppercase tracking-[0.2em] mb-6">Leaderboard</h2>
        ...
        {/* Divider: Leaderboard → Next Decision */}
        <div className="flex justify-center my-8 sm:my-12">
          <div className="w-px h-12 sm:h-16 bg-neutral-200" />
        </div>
          ...
          <section className="mb-0">
            <div className="border border-neutral-200">
              ...
              <div className="flex items-center justify-between px-4 sm:px-8 py-4 border-b border-neutral-100">
                <span className="text-xs font-medium text-neutral-400 uppercase tracking-[0.2em]">Next Decision</span>
              ...
              <div className="px-4 sm:px-8 py-8">
                <h2 className="font-serif text-xl sm:text-3xl font-light tracking-tight mb-3">
                  Will the FDA <em className="italic">approve</em> {nextFdaEvent.drugName.split(' ')[0]}?
                </h2>
                    ...
                    <div key={modelId} className="py-4 sm:py-8 text-center border-r border-b sm:border-b-0 border-neutral-200">
                      ...
                      {pred ? (
                        <div>
                          ...
                          <div className="text-sm text-neutral-400 mt-1 font-mono">{pred.confidence}%</div>
                        </div>
                      ) : (
        ...
        {/* Divider: Next Decision → Upcoming */}
        <div className="flex justify-center my-8 sm:my-12">
          <div className="w-px h-12 sm:h-16 bg-neutral-200" />
        </div>
        ...
        <section className="mb-0">
          <div className="border border-neutral-200">
            {/* Header */}
            <div className="flex items-center justify-between px-4 sm:px-6 py-5 border-b border-neutral-200">
              <h2 className="text-xs font-medium text-neutral-400 uppercase tracking-[0.2em]">Upcoming Decisions</h2>
              <Link href="/fda-calendar" className="text-xs text-neutral-400 hover:text-neutral-900 transition-colors">View all →</Link>
            </div>
            ...
            <div className="sm:hidden divide-y divide-neutral-100">
              ...
              {upcomingFdaEvents.length === 0 && (
                <div className="py-8 text-center text-neutral-400">No upcoming decisions</div>
              )}
            </div>
            ...
            <div className="hidden sm:block overflow-x-auto">
              <table className="w-full">
                <thead>
                  <tr className="border-b border-neutral-200 text-neutral-400 text-[11px] uppercase tracking-[0.2em]">
                    <th className="text-left px-4 py-4 font-medium w-[70px]">PDUFA</th>
                    <th className="text-left px-4 py-4 font-medium w-[110px]">Drug</th>
                    <th className="text-left px-4 py-4 font-medium">Event</th>
                    <th className="text-left px-4 py-4 font-medium w-[60px]">Type</th>
                    <th className="text-left px-4 py-4 font-medium w-[70px]">Ticker</th>
                    <th className="text-center px-3 py-4 w-[80px]"><div className="w-5 h-5 mx-auto text-neutral-400" title="FDA"><FDAIcon /></div></th>
                    <th className="text-center px-3 py-4 w-[48px]"><div className="w-4 h-4 mx-auto text-neutral-400" title="Claude Opus 4.6"><ModelIcon id="claude" /></div></th>
                    <th className="text-center px-3 py-4 w-[48px]"><div className="w-4 h-4 mx-auto text-neutral-400" title="GPT-5.2"><ModelIcon id="gpt" /></div></th>
                    <th className="text-center px-3 py-4 w-[48px]"><div className="w-4 h-4 mx-auto text-neutral-400" title="Grok 4.1"><ModelIcon id="grok" /></div></th>
                  </tr>
                </thead>
                <tbody>
                  {upcomingFdaEvents.map((event) => (
        ...
        <section className="mb-0">
          <div className="border border-neutral-200">
            {/* Header */}
            <div className="flex items-center justify-between px-4 sm:px-6 py-5 border-b border-neutral-200">
              <h2 className="text-xs font-medium text-neutral-400 uppercase tracking-[0.2em]">Past Decisions</h2>
              <Link href="/fda-calendar" className="text-xs text-neutral-400 hover:text-neutral-900 transition-colors">View all →</Link>
            </div>
            ...
            <div className="sm:hidden divide-y divide-neutral-100">
              ...
              {recentFdaDecisions.length === 0 && (
                <div className="py-8 text-center text-neutral-400">No decisions yet</div>
              )}
            </div>
